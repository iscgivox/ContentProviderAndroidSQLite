...
public class UsuariosDAO {
	...
	public long insert(Usuario usuario, boolean flag) {
		...
		try {
			return _ad.insert(DBUsuarios.TABLE_NAME_USUARIOS, null, cv);
		} catch (SQLiteException e) {
			// TODO: handle exception
			throw e;
		}
	...
	public Cursor getAll(String[] projection, String selection,
						 String[] selectionArgs) {
		Cursor c=null;

		try {
			c = _ad.query("usuarios",projection,selection,selectionArgs,
					null,null,null);
		} catch (SQLiteException e) {
			// TODO: handle exception
			throw e;
